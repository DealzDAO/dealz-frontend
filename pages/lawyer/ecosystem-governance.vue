...
<div>
    <div class="container-fluid mild-back">
        <div class="row py-3 px-4 line-border">
        ...
        <div class="row px-4 line-border">
            <div class="col-6">
                <b-tabs pills active-nav-item-class="font-weight-bold text-primary" active-tab-class="bg-primary-light" v-model="tabIndex">
                    <b-tab title="Approve New Attorney" @click="setTab(0,'approve-attorney')" class="menu-text" :title-link-class="linkClass(0)"></b-tab>
                    <b-tab title="Platform Changes" @click="setTab(0,'platform-changes')" class="menu-text" :title-link-class="linkClass(1)"></b-tab>
                </b-tabs>
            </div>
            <div class="col-6">
...
export default {
    ...
    methods: {
        ...
        setTab(n1, n2) {
            this.tab = n1,
                this.$router.push('/lawyer/ecosystem-governance/' + n2)
        }
    }
};
</script>
