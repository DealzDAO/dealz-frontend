<template>
  <div>
        ...
        <div class="bg-white viewBox">
          <div class="col">
            ...
            <div class="row justify-content-end">
              <p
                class="float-right text-helper helper-text"
                style="cursor:pointer"
                @click="fullViewDialog = true"
              >
            ...
            <p class="helper-text3" v-for="(item, i) in start" :key="i">
              <span class="num-list mr-2">{{ i + 1 }}</span
              >{{ item.title }}
            </p>
            ...
            <b-button block class="my-btn mt-3" @click="continuePayment"
    ...
    <b-modal size="xl" scrollable centered v-model="fullViewDialog" hide-footer>
      <div
        class="full-box hidden-scroll px-10"
        v-html="selectedContract.contract_details"
      ></div>
    </b-modal>
  </div>
</template>
  ...
  data() {
    return {
      ...
      start: [
        ...
        {
          title:
            "Nunc, pellentesque dui amet leo integer lobortis egestas duis."
        },
        {
          title:
            "Semper enim condimentum ac lectus consequat porttitor proin ac vitae."
        }
      ],
      usecase: [
        {
      ...
      customers: [
        {
          ...
          name: "John Doe",
          text:
            "Tellus dictum tempor parturient et nunc justo varius. Pharetra vel enim justo, mi elementum pulvinar in. Fringilla nullam viverra augue eleifend."
        },
        {
          rating: "4",
          name: "John Doe",
          text:
            "Aliquam velit nunc pellentesque sapien pulvinar eu eget egestas. Mi eu arcu, id arcu in lacus habitasse vel nec. Tristique nisl ut sapien aliquam vel rhoncus feugiat. Maecenas turpis adipiscing at sodales egestas vestibulum tellus."
        },
        {
          rating: "4",
          name: "John Doe",
          text:
            "Eleifend suspendisse pulvinar potenti lacus, elit nisl. Rhoncus sit sapien massa a hendrerit et augue. Eget eu tortor volutpat suspendisse. Magna auctor eget pellentesqu"
        }
      ]
    };
  },
