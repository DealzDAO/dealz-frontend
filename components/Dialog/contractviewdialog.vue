...
<div>
    <b-modal size="xl" centered v-model="contractDialog" hide-footer>
        <div class="bg-white viewBox">
            <div class="col">
                <p class="title-text2">Brain Trust New Sound Exchange Procedures For LOD</p>
                ...
                <b-button block class="my-btn mt-3">Select Contract</b-button>
            </div>
        </div>
    </b-modal>
</div>
...
export default {
    ...
    methods: {
        closeDialog(){
            this.$store.commit('unsetContractDialog')
        }
    }
}
</script>
