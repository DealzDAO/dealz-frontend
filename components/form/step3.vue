    ...
    <div class="container">
      <div class="row pt-3">
        ...
        <div class="col-6">
            ...
            <div>
              ...
              <b-input-group class="p-0">
                ...
                <b-form-input
                  disabled
                  :value="item.question"
                  class="input-style input-adjust"
          ...
          <div
            class="mt-3"
            v-if="questioning == true && type == 'Multiple Choice'"
          >
            <b-input
...
export default {
  ...
  methods: {
    ...
    selectWord() {
      this.pos = window.getSelection().anchorOffset;
      if (this.qCount == this.questions.length) {
        ...
        document.execCommand(
          "insertHtml",
          false,
          "<span style='display:hidden'>{{" + this.selected + "}}</span>"
        );
      } else {
        this.warn = true;
